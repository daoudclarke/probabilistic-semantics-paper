...
We interpret this conditional probability as the {\em degree to which $s_2$ entails $s_1$\/}. Note that $s_2$ logical entails $s_1$ if and only if the degree to which  $s_2$ entails $s_1$ is $1.0$.
...
Section~\titleref{sec:recovering} we consider how this representation
