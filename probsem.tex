...
demonstrate that inference for this formalism is NP-hard.
...
logical truth functions for conjunction and negation with probability 1. Note for example that there is an interpretation for which $\land (P_1)(\lnot (P_2))$ has value $\top$. On the other hand, the sentence $\land (P_1)(\lnot (P_1))$ will have value $\bot$ for all interpretations.
