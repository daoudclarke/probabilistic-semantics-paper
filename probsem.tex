...
\begin{abstract}
% \begin{quote}
  Distributional representations of meaning typically represent words
  as vectors or probability distributions over contexts. Such
  approaches to the representation of meaning differ markedly from
  ...
  compositional approaches. This paper presents a new formalism, {\em
    probabilistic semantics\/}, which seeks to provide such a unifying
  ...
  models. We sketch a probabilistic extension of Montague-style
  semantics and consider an application of our approach to the core
  task of textual entailment. We describe an implementation of our
  formalism and, using simple examples, demonstrate that it can learn
  that monotonically decreasing quantifiers reverse the direction of
  entailment.
% \end{quote}
\end{abstract}
...
In the following we sketch a probabilistic extension of Montague semantics, present a way of defining a probability distribution over models in terms of a random generation process over interpretations and consider an application to the core task of textual entailment.  We describe an implementation of our approach within the framework of \citet{Sato:97}.  We also  relate the learnt
