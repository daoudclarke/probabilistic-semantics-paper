...
models. We sketch a probabilistic extension for a Montague-style
semantics and demonstrate its properties on simple examples. We also
propose an approach for learning semantics directly from data, and
discuss how the technique could be applied to the task of recognising
textual entailment.
% \end{quote}
\end{abstract}
...
semantics by \cite{Sato:95}, however to our knowledge it has not been
