...
logical truth functions for conjunction and negation with probability 1. Note that there must be an interpretation for which $\land (P_1)(\lnot (P_2))$ has value $\top$. In contrast, a sentence such as $\land (P_1)(\lnot (P_1))$ must have value $\bot$ for all interpretations.
